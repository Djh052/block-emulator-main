...
func (cphm *PLouvainPbftInsideExtraHandleMod) sendPartitionReady() {
...
func (cphm *PLouvainPbftInsideExtraHandleMod) getPartitionReady() bool {
	cphm.cdm.P_ReadyLock.Lock()
...
func (cphm *PLouvainPbftInsideExtraHandleMod) sendAccounts_and_Txs() {
...
// fetch collect infos
func (cphm *PLouvainPbftInsideExtraHandleMod) getCollectOver() bool {
...
func (cphm *PLouvainPbftInsideExtraHandleMod) proposePartition() (bool, *message.Request) {
...
func (cphm *PLouvainPbftInsideExtraHandleMod) accountTransfer_do(atm *message.AccountTransferMsg) {
